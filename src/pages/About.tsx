...
const About = ({ language }: AboutProps) => {
  const translations = {
    en: {
      ...
      ourStory: 'Our Story',
      storyText: 'Christ Apostolic Church (CAC) Alagomeji, Yaba, also known as Oke-Ibukun, has been a pillar of faith in the Lagos community for decades. We are committed to spreading the gospel of Jesus Christ and nurturing spiritual growth among our members and the wider community.',
      chairman: 'District Pastor',
      chairmanName: 'Rev. Dr. Emmanuel Adeyemi',
      chairmanBio: 'Rev. Dr. Adeyemi has been leading our congregation with wisdom and compassion for over 15 years. His vision for a modern, inclusive church has transformed CAC Yaba into a beacon of hope and spiritual excellence.',
      mission: 'Our Mission',
    ...
    yo: {
      ...
      chairmanName: 'Rev. Dr. Emmanuel Adeyemi',
      chairmanBio: 'Rev. Dr. Adeyemi ti ń darí ìjọ wa pẹ̀lú ọgbọ́n àti ìyọ́nú fún ọdún mẹ́ẹ̀ẹ́dógún sẹ́yìn. Ìran rẹ̀ fún ìjọ òde òní tí ó ní ìfowópamọ́ ti yí CAC Yaba padà di àmì ìrètí àti ìdárayá ti ẹ̀mí.',
